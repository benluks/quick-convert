...
class DepthWiseConvolution(nn.Module):
    ...
    def __init__(self, channels: int = 256, kernel_size: int = 9, bias: bool = True, dropout: float = 0.0):
        ...
        self.pw_conv1 = nn.Conv1d(channels, 2 * channels, kernel_size=1, stride=1, padding=0, bias=bias)
        ...
        self.pw_conv2 = nn.Conv1d(channels, channels, kernel_size=1, stride=1, padding=0, bias=bias)
