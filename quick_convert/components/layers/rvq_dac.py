...
from .rvq import BaseResidualVectorQuantizer, RVQLosses, RVQOutput
...
class VectorQuantize(BaseResidualVectorQuantizer):
    """
    Implementation of VQ taken from DAC:
    https://github.com/descriptinc/descript-audio-codec/blob/main/dac/nn/quantize.py
    Based on Karphaty's implementation:
    https://github.com/karpathy/deep-vector-quantization
    Uses these tricks from Improved VQGAN https://arxiv.org/pdf/2110.04627.pdf):
    ...
    def __init__(self, input_dim: int, codebook_size: int, codebook_dim: int, output_dim: int | None = None):
        super().__init__()
    ...
    def decode_latents(self, latents):
        ...
        indices = (-dist).argmax(dim=1).reshape(b, t)
        z_q = self.decode_code(indices)
        return z_q, indices


class ResidualVectorQuantizerDAC(nn.Module):
    """
