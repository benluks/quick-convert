...
class NACAnonymizer(BaseAnonymizer[NACTarget]):
    def __init__(self, checkpoint_dir: str, voice_dirs: Union[list[str], None] = None):
        ...
        self.sr = self.sample_rate = self.model.config.sample_rate
...
if __name__ == "__main__":
    checkpoint_dir = "/cfs/home/u036742/.local/share/tts/tts_models--multilingual--multi-dataset--bark"
    checkpoint_dir = "checkpoints/nac_models"  # this also works

    anonymizer = NACAnonymizer(checkpoint_dir)
