...
- [`content_encoders`] encode frame-wise content from an utterance. This is usually linguistic content such as the VQ-BN extractor output in `ASR-BN` (B5), the E2E ASR system in `STTTS` (B3), or representations from an SSL model.
